...
TempleExModules["icons"] = function()
--[[
...
local Config = TempleExRequire("config")
local Log = TempleExRequire("log")
local Icons = TempleExRequire("icons")
...
TempleApi.version = {major = 1, minor = 0, patch = 3}
TempleApi._windows = {}
...
local TempleEx = {}
TempleEx.version = {major = 1, minor = 0, patch = 3}
